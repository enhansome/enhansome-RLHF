...
* [OpenRLHF: A Ray-based Easy-to-use, Scalable and High-performance RLHF Framework](https://aclanthology.org/2025.emnlp-demos.48/)
  * Code: [Official](https://github.com/OpenRLHF/OpenRLHF) ⭐ 9,907 | 🐛 361 | 🌐 Python | 📅 2026-07-14
...
* [REINFORCE++: A Simple and Efficient Approach for Aligning Large Language Models](https://arxiv.org/abs/2501.03262)
  * Code: [Official](https://github.com/OpenRLHF/OpenRLHF/blob/main/examples/scripts/train_reinforce_llama_ray.sh) ⭐ 9,907 | 🐛 361 | 🌐 Python | 📅 2026-07-14
  * Jian Hu
...
* [HybridFlow: A Flexible and Efficient RLHF Framework](https://arxiv.org/pdf/2409.19256v2)
  * Code: [Official](https://github.com/volcengine/verl) ⭐ 22,935 | 🐛 1,095 | 🌐 Python | 📅 2026-08-13
...
* [GPT-4 Technical Report](https://cdn.openai.com/papers/gpt-4.pdf)
  * Code: [official](https://github.com/openai/evals) ⭐ 19,156 | 🐛 225 | 🌐 Python | 📅 2026-04-14
...
* [Visual ChatGPT: Talking, Drawing and Editing with Visual Foundation Models](https://arxiv.org/pdf/2303.04671.pdf)
  * Code: [official](https://github.com/microsoft/visual-chatgpt) ⭐ 34,021 | 🐛 263 | 🌐 Python | 📅 2024-01-06
...
* [veRL: Volcano Engine Reinforcement Learning for LLM](https://github.com/volcengine/verl) ⭐ 22,935 | 🐛 1,095 | 🌐 Python | 📅 2026-08-13
...
* [Transformer Reinforcement Learning (TRL)](https://github.com/lvwerra/trl) ⭐ 19,062 | 🐛 263 | 🌐 Python | 📅 2026-08-13
...
* [OpenRLHF](https://github.com/OpenRLHF/OpenRLHF) ⭐ 9,907 | 🐛 361 | 🌐 Python | 📅 2026-07-14
  * OpenRLHF
