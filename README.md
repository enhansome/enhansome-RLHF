...
* [OpenRLHF: A Ray-based Easy-to-use, Scalable and High-performance RLHF Framework](https://aclanthology.org/2025.emnlp-demos.48/)
  * Code: [Official](https://github.com/OpenRLHF/OpenRLHF) ⭐ 9,910 | 🐛 356 | 🌐 Python | 📅 2026-08-13
...
* [REINFORCE++: A Simple and Efficient Approach for Aligning Large Language Models](https://arxiv.org/abs/2501.03262)
  * Code: [Official](https://github.com/OpenRLHF/OpenRLHF/blob/main/examples/scripts/train_reinforce_llama_ray.sh) ⭐ 9,910 | 🐛 356 | 🌐 Python | 📅 2026-08-13
  * Jian Hu
...
* [HybridFlow: A Flexible and Efficient RLHF Framework](https://arxiv.org/pdf/2409.19256v2)
  * Code: [Official](https://github.com/volcengine/verl) ⭐ 22,957 | 🐛 1,118 | 🌐 Python | 📅 2026-08-14
...
* [GPT-4 Technical Report](https://cdn.openai.com/papers/gpt-4.pdf)
  * Code: [official](https://github.com/openai/evals) ⭐ 19,166 | 🐛 225 | 🌐 Python | 📅 2026-04-14
...
* [Visual ChatGPT: Talking, Drawing and Editing with Visual Foundation Models](https://arxiv.org/pdf/2303.04671.pdf)
  * Code: [official](https://github.com/microsoft/visual-chatgpt) ⭐ 34,018 | 🐛 263 | 🌐 Python | 📅 2024-01-06
...
* [veRL: Volcano Engine Reinforcement Learning for LLM](https://github.com/volcengine/verl) ⭐ 22,957 | 🐛 1,118 | 🌐 Python | 📅 2026-08-14
...
* [Transformer Reinforcement Learning (TRL)](https://github.com/lvwerra/trl) ⭐ 19,069 | 🐛 271 | 🌐 Python | 📅 2026-08-14
...
* [OpenRLHF](https://github.com/OpenRLHF/OpenRLHF) ⭐ 9,910 | 🐛 356 | 🌐 Python | 📅 2026-08-13
  * OpenRLHF
...
* [DeepSpeed-Chat](https://github.com/microsoft/DeepSpeedExamples/tree/master/applications/DeepSpeed-Chat) ⭐ 6,835 | 🐛 327 | 🌐 Python | 📅 2026-08-04
  * Microsoft
