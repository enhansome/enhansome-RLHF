...
* [OpenRLHF: A Ray-based Easy-to-use, Scalable and High-performance RLHF Framework](https://aclanthology.org/2025.emnlp-demos.48/)
  * Code: [Official](https://github.com/OpenRLHF/OpenRLHF) ⭐ 10,013 | 🐛 380 | 🌐 Python | 📅 2026-09-17
...
* [REINFORCE++: A Simple and Efficient Approach for Aligning Large Language Models](https://arxiv.org/abs/2501.03262)
  * Code: [Official](https://github.com/OpenRLHF/OpenRLHF/blob/main/examples/scripts/train_reinforce_llama_ray.sh) ⭐ 10,013 | 🐛 380 | 🌐 Python | 📅 2026-09-17
  * Jian Hu
...
* [HybridFlow: A Flexible and Efficient RLHF Framework](https://arxiv.org/pdf/2409.19256v2)
  * Code: [Official](https://github.com/volcengine/verl) ⭐ 23,472 | 🐛 1,229 | 🌐 Python | 📅 2026-09-17
...
* [Preference Ranking Optimization for Human Alignment](https://arxiv.org/pdf/2306.17492)
  * Code: [official](https://github.com/AlibabaResearch/DAMO-ConvAI/tree/main/PRO) ⭐ 1,599 | 🐛 80 | 🌐 Python | 📅 2026-09-15
...
* [GPT-4 Technical Report](https://cdn.openai.com/papers/gpt-4.pdf)
  * Code: [official](https://github.com/openai/evals) ⭐ 19,472 | 🐛 340 | 🌐 Python | 📅 2026-04-14
...
* [Training a Helpful and Harmless Assistant with Reinforcement Learning from Human Feedback](https://arxiv.org/abs/2204.05862)
  * Dataset: [TriviaQA](http://nlp.cs.washington.edu/triviaqa/), [HellaSwag](https://rowanzellers.com/hellaswag/), [ARC](https://allenai.org/data/arc), [OpenBookQA](https://allenai.org/data/open-book-qa), [LAMBADA](https://zenodo.org/record/2630551#.Y_KLJ-yZNhF), [HumanEval](https://github.com/openai/human-eval) ⭐ 3,382 | 🐛 45 | 🌐 Python | 📅 2025-01-17, [MMLU](https://github.com/hendrycks/test) ⭐ 1,616 | 🐛 17 | 🌐 Python | 📅 2023-05-28, [TruthfulQA](https://github.com/sylinrl/TruthfulQA) ⭐ 946 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2025-01-16
  * Code: [official](https://github.com/anthropics/hh-rlhf) ⚠️ Archived
...
* [veRL: Volcano Engine Reinforcement Learning for LLM](https://github.com/volcengine/verl) ⭐ 23,472 | 🐛 1,229 | 🌐 Python | 📅 2026-09-17
...
* [Transformer Reinforcement Learning (TRL)](https://github.com/lvwerra/trl) ⭐ 19,330 | 🐛 306 | 🌐 Python | 📅 2026-09-17
...
* [OpenRLHF](https://github.com/OpenRLHF/OpenRLHF) ⭐ 10,013 | 🐛 380 | 🌐 Python | 📅 2026-09-17
  * OpenRLHF
