...
* [OpenRLHF: A Ray-based Easy-to-use, Scalable and High-performance RLHF Framework](https://aclanthology.org/2025.emnlp-demos.48/)
  * Code: [Official](https://github.com/OpenRLHF/OpenRLHF) ⭐ 9,960 | 🐛 363 | 🌐 Python | 📅 2026-08-13
...
* [REINFORCE++: A Simple and Efficient Approach for Aligning Large Language Models](https://arxiv.org/abs/2501.03262)
  * Code: [Official](https://github.com/OpenRLHF/OpenRLHF/blob/main/examples/scripts/train_reinforce_llama_ray.sh) ⭐ 9,960 | 🐛 363 | 🌐 Python | 📅 2026-08-13
  * Jian Hu
...
* [HybridFlow: A Flexible and Efficient RLHF Framework](https://arxiv.org/pdf/2409.19256v2)
  * Code: [Official](https://github.com/volcengine/verl) ⭐ 23,189 | 🐛 1,154 | 🌐 Python | 📅 2026-08-29
...
* [Aligning Large Multimodal Models with Factually Augmented RLHF](https://arxiv.org/abs/2309.14525)
  * Code: [Official](https://github.com/llava-rlhf/LLaVA-RLHF) ⭐ 399 | 🐛 4 | 🌐 Python | 📅 2023-11-01
...
* [GPT-4 Technical Report](https://cdn.openai.com/papers/gpt-4.pdf)
  * Code: [official](https://github.com/openai/evals) ⭐ 19,304 | 🐛 326 | 🌐 Python | 📅 2026-04-14
...
* [RAFT: Reward rAnked FineTuning for Generative Foundation Model Alignment](https://arxiv.org/pdf/2304.06767.pdf)
  * Code: [official](https://github.com/OptimalScale/LMFlow) ⭐ 8,485 | 🐛 88 | 🌐 Python | 📅 2026-08-10
...
* [Visual ChatGPT: Talking, Drawing and Editing with Visual Foundation Models](https://arxiv.org/pdf/2303.04671.pdf)
  * Code: [official](https://github.com/microsoft/visual-chatgpt) ⭐ 33,999 | 🐛 261 | 🌐 Python | 📅 2024-01-06
...
* [Training a Helpful and Harmless Assistant with Reinforcement Learning from Human Feedback](https://arxiv.org/abs/2204.05862)
  * Dataset: [TriviaQA](http://nlp.cs.washington.edu/triviaqa/), [HellaSwag](https://rowanzellers.com/hellaswag/), [ARC](https://allenai.org/data/arc), [OpenBookQA](https://allenai.org/data/open-book-qa), [LAMBADA](https://zenodo.org/record/2630551#.Y_KLJ-yZNhF), [HumanEval](https://github.com/openai/human-eval) ⭐ 3,355 | 🐛 45 | 🌐 Python | 📅 2025-01-17, [MMLU](https://github.com/hendrycks/test) ⭐ 1,613 | 🐛 16 | 🌐 Python | 📅 2023-05-28, [TruthfulQA](https://github.com/sylinrl/TruthfulQA) ⭐ 941 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2025-01-16
  * Code: [official](https://github.com/anthropics/hh-rlhf) ⚠️ Archived
...
* [veRL: Volcano Engine Reinforcement Learning for LLM](https://github.com/volcengine/verl) ⭐ 23,189 | 🐛 1,154 | 🌐 Python | 📅 2026-08-29
...
* [Transformer Reinforcement Learning (TRL)](https://github.com/lvwerra/trl) ⭐ 19,174 | 🐛 296 | 🌐 Python | 📅 2026-08-29
...
* [OpenRLHF](https://github.com/OpenRLHF/OpenRLHF) ⭐ 9,960 | 🐛 363 | 🌐 Python | 📅 2026-08-13
  * OpenRLHF
...
* [DeepSpeed-Chat](https://github.com/microsoft/DeepSpeedExamples/tree/master/applications/DeepSpeed-Chat) ⭐ 6,841 | 🐛 325 | 🌐 Python | 📅 2026-08-26
  * Microsoft
...
* [Potato](https://github.com/davidjurgens/potato) ⭐ 417 | 🐛 3 | 🌐 Python | 📅 2026-08-28
  * David Jurgens et al.
...
* [FG-RLHF](https://finegrainedrlhf.github.io/)
  * Task: A framework that enables training and learning from reward functions that are fine-grained in density and multiple RMs
    -[Safe-RLHF](https://github.com/PKU-Alignment/safe-rlhf) ⭐ 1,612 | 🐛 18 | 🌐 Python | 📅 2025-11-24
