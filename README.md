...
* [OpenRLHF: A Ray-based Easy-to-use, Scalable and High-performance RLHF Framework](https://aclanthology.org/2025.emnlp-demos.48/)
  * Code: [Official](https://github.com/OpenRLHF/OpenRLHF) ⭐ 9,994 | 🐛 367 | 🌐 Python | 📅 2026-09-10
...
* [REINFORCE++: A Simple and Efficient Approach for Aligning Large Language Models](https://arxiv.org/abs/2501.03262)
  * Code: [Official](https://github.com/OpenRLHF/OpenRLHF/blob/main/examples/scripts/train_reinforce_llama_ray.sh) ⭐ 9,994 | 🐛 367 | 🌐 Python | 📅 2026-09-10
  * Jian Hu
...
* [HybridFlow: A Flexible and Efficient RLHF Framework](https://arxiv.org/pdf/2409.19256v2)
  * Code: [Official](https://github.com/volcengine/verl) ⭐ 23,389 | 🐛 1,214 | 🌐 Python | 📅 2026-09-11
...
* [GPT-4 Technical Report](https://cdn.openai.com/papers/gpt-4.pdf)
  * Code: [official](https://github.com/openai/evals) ⭐ 19,434 | 🐛 337 | 🌐 Python | 📅 2026-04-14
  * Dataset: [DROP](https://allenai.org/data/drop), [WinoGrande](https://winogrande.allenai.org/), [HellaSwag](https://rowanzellers.com/hellaswag/), [ARC](https://allenai.org/data/arc), [HumanEval](https://github.com/openai/human-eval) ⭐ 3,372 | 🐛 45 | 🌐 Python | 📅 2025-01-17, [GSM8K](https://paperswithcode.com/dataset/gsm8k), [MMLU](https://paperswithcode.com/dataset/mmlu), [TruthfulQA](https://github.com/sylinrl/TruthfulQA) ⭐ 945 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2025-01-16
  * OpenAI
...
* [RAFT: Reward rAnked FineTuning for Generative Foundation Model Alignment](https://arxiv.org/pdf/2304.06767.pdf)
  * Code: [official](https://github.com/OptimalScale/LMFlow) ⭐ 8,488 | 🐛 88 | 🌐 Python | 📅 2026-08-10
...
* [Training a Helpful and Harmless Assistant with Reinforcement Learning from Human Feedback](https://arxiv.org/abs/2204.05862)
  * Dataset: [TriviaQA](http://nlp.cs.washington.edu/triviaqa/), [HellaSwag](https://rowanzellers.com/hellaswag/), [ARC](https://allenai.org/data/arc), [OpenBookQA](https://allenai.org/data/open-book-qa), [LAMBADA](https://zenodo.org/record/2630551#.Y_KLJ-yZNhF), [HumanEval](https://github.com/openai/human-eval) ⭐ 3,372 | 🐛 45 | 🌐 Python | 📅 2025-01-17, [MMLU](https://github.com/hendrycks/test) ⭐ 1,616 | 🐛 16 | 🌐 Python | 📅 2023-05-28, [TruthfulQA](https://github.com/sylinrl/TruthfulQA) ⭐ 945 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2025-01-16
  * Code: [official](https://github.com/anthropics/hh-rlhf) ⚠️ Archived
...
* [Teaching language models to support answers with verified quotes](https://arxiv.org/abs/2203.11147) (GopherCite)
  * Dataset: [Natural Questions](https://ai.google.com/research/NaturalQuestions), [ELI5](https://facebookresearch.github.io/ELI5/), [QuALITY](https://github.com/nyu-mll/quality) ⭐ 154 | 🐛 5 | 🌐 Python | 📅 2025-01-17, [TruthfulQA](https://github.com/sylinrl/TruthfulQA) ⭐ 945 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2025-01-16
...
* [Training language models to follow instructions with human feedback](https://arxiv.org/abs/2203.02155) (InstructGPT)
  ...
  * Dataset: [TruthfulQA](https://github.com/sylinrl/TruthfulQA) ⭐ 945 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2025-01-16, [RealToxicityPrompts](https://allenai.org/data/real-toxicity-prompts)
...
* [WebGPT: Browser-assisted question-answering with human feedback](https://arxiv.org/abs/2112.09332) (WebGPT)
  * Dataset: [ELI5](https://facebookresearch.github.io/ELI5/), [TriviaQA](http://nlp.cs.washington.edu/triviaqa/), [TruthfulQA](https://github.com/sylinrl/TruthfulQA) ⭐ 945 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2025-01-16
...
* [veRL: Volcano Engine Reinforcement Learning for LLM](https://github.com/volcengine/verl) ⭐ 23,389 | 🐛 1,214 | 🌐 Python | 📅 2026-09-11
...
* [Transformer Reinforcement Learning (TRL)](https://github.com/lvwerra/trl) ⭐ 19,281 | 🐛 306 | 🌐 Python | 📅 2026-09-11
...
* [OpenRLHF](https://github.com/OpenRLHF/OpenRLHF) ⭐ 9,994 | 🐛 367 | 🌐 Python | 📅 2026-09-10
  * OpenRLHF
...
* [Potato](https://github.com/davidjurgens/potato) ⭐ 421 | 🐛 6 | 🌐 Python | 📅 2026-09-10
  * David Jurgens et al.
...
* [FG-RLHF](https://finegrainedrlhf.github.io/)
  * Task: A framework that enables training and learning from reward functions that are fine-grained in density and multiple RMs
    -[Safe-RLHF](https://github.com/PKU-Alignment/safe-rlhf) ⭐ 1,615 | 🐛 18 | 🌐 Python | 📅 2025-11-24
