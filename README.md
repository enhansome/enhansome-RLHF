...
* [OpenRLHF: A Ray-based Easy-to-use, Scalable and High-performance RLHF Framework](https://aclanthology.org/2025.emnlp-demos.48/)
  * Code: [Official](https://github.com/OpenRLHF/OpenRLHF) ⭐ 9,958 | 🐛 362 | 🌐 Python | 📅 2026-08-13
...
* [REINFORCE++: A Simple and Efficient Approach for Aligning Large Language Models](https://arxiv.org/abs/2501.03262)
  * Code: [Official](https://github.com/OpenRLHF/OpenRLHF/blob/main/examples/scripts/train_reinforce_llama_ray.sh) ⭐ 9,958 | 🐛 362 | 🌐 Python | 📅 2026-08-13
  * Jian Hu
...
* [HybridFlow: A Flexible and Efficient RLHF Framework](https://arxiv.org/pdf/2409.19256v2)
  * Code: [Official](https://github.com/volcengine/verl) ⭐ 23,183 | 🐛 1,149 | 🌐 Python | 📅 2026-08-29
...
* [GPT-4 Technical Report](https://cdn.openai.com/papers/gpt-4.pdf)
  * Code: [official](https://github.com/openai/evals) ⭐ 19,298 | 🐛 324 | 🌐 Python | 📅 2026-04-14
...
* [Visual ChatGPT: Talking, Drawing and Editing with Visual Foundation Models](https://arxiv.org/pdf/2303.04671.pdf)
  * Code: [official](https://github.com/microsoft/visual-chatgpt) ⭐ 34,000 | 🐛 261 | 🌐 Python | 📅 2024-01-06
...
* [veRL: Volcano Engine Reinforcement Learning for LLM](https://github.com/volcengine/verl) ⭐ 23,183 | 🐛 1,149 | 🌐 Python | 📅 2026-08-29
...
* [Transformer Reinforcement Learning (TRL)](https://github.com/lvwerra/trl) ⭐ 19,173 | 🐛 291 | 🌐 Python | 📅 2026-08-29
...
* [OpenRLHF](https://github.com/OpenRLHF/OpenRLHF) ⭐ 9,958 | 🐛 362 | 🌐 Python | 📅 2026-08-13
  * OpenRLHF
